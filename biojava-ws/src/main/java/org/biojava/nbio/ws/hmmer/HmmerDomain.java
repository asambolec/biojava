...
public class HmmerDomain implements Comparable<HmmerDomain>, Serializable {
	...
	public String toString() {
		return new StringBuilder().append("HmmerDomain [hmmAcc=").append(hmmAcc).append(", hmmDesc=").append(hmmDesc)
				.append("sqFrom=").append(sqFrom).append(", sqTo=").append(sqTo).append(", aliLenth=").append(aliLenth)
				.append(", simCount=").append(simCount).append(", hmmFrom=").append(hmmFrom).append(", hmmTo=")
				.append(hmmTo).append(", hmmName=").append(hmmName).append("]").toString();
	 ...
	 * "alihmmto":"53","alirfline":0, "bitscore":14.0345134735107,"bias":"0.20",
	 * "alisqfrom":"42", "alisqname":"1","aliappline":0,
	 * "alihmmfrom":"33","alimem":46912854337136,
	 * "aliId":0.19047619047619,"is_included":"0", "alisqdesc":"","ienv":"36"}]
	 */
