...
public class HmmerResult implements Comparable<HmmerResult>, Serializable {
	...
	public String toString() {
		return new StringBuilder().append("HmmerResult [acc=").append(acc).append(", desc=").append(desc)
				.append(", score=").append(score).append(", evalue=").append(evalue).append(", pvalue=").append(pvalue)
				.append(", dcl=").append(dcl).append(", name=").append(name).append(", ndom=").append(ndom)
				.append(", nreported=").append(nreported).append(", domains=").append(domains).append("]").toString();
	}
