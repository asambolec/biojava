...
public final class SequenceUtil {
	 ...
	 * Valid Amino acids
	 */
	public static final Pattern AA = Pattern.compile("[ARNDCQEGHILKMFPSTWYVUO]+", Pattern.CASE_INSENSITIVE);

	/**
	 * inversion of AA pattern
	 */
	public static final Pattern NON_AA = Pattern.compile("[^ARNDCQEGHILKMFPSTWYVXUO]+", Pattern.CASE_INSENSITIVE);

	/**
	 * Same as AA pattern but with one additional letters - X
	 */
	public static final Pattern AMBIGUOUS_AA = Pattern.compile("[ARNDCQEGHILKMFPSTWYVXUO]+", Pattern.CASE_INSENSITIVE);

	/**
	 * Nucleotides a, t, g, c, u
	 */
	public static final Pattern NUCLEOTIDE = Pattern.compile("[AGTCU]+", Pattern.CASE_INSENSITIVE);

	/**
	 * Ambiguous nucleotide
	 */
	public static final Pattern AMBIGUOUS_NUCLEOTIDE = Pattern.compile("[AGTCRYMKSWHBVDNU]+", Pattern.CASE_INSENSITIVE); // see
																															// IUPAC
	/**
	 * Non nucleotide
	 */
	public static final Pattern NON_NUCLEOTIDE = Pattern.compile("[^AGTCU]+", Pattern.CASE_INSENSITIVE);

	private SequenceUtil() {
	} // utility class, no instantiation

	/*
	 * public static void write_PirSeq(OutputStream os, FastaSequence seq) throws
	 * IOException { BufferedWriter pir_out = new BufferedWriter(new
	 ...
	 *
	 * public static void write_FastaSeq(OutputStream os, FastaSequence seq) throws
	 * IOException { BufferedWriter fasta_out = new BufferedWriter( new
	...
	/**
	 * Removes all special characters and digits as well as whitespace chars from
	 * the sequence
	 *
	 * @param sequence
	 * @return cleaned up sequence
	 ...
	 *
	 * @param sequence
	 * @return return true only if the sequence if ambiguous protein sequence Return
	 *         false otherwise. e.g. if the sequence is non-ambiguous protein or DNA
	 */
	...
	/**
	 * Writes list of FastaSequeces into the outstream formatting the sequence so
	 * that it contains width chars on each line
	 *
	 * @param outstream
	 * @param sequences
	 ...
	 * @throws IOException
	 */
	public static void writeFasta(final OutputStream outstream, final List<FastaSequence> sequences, final int width)
			throws IOException {
	 ...
	 * @throws IOException
	 */
	public static void writeFasta(final OutputStream os, final List<FastaSequence> sequences) throws IOException {
