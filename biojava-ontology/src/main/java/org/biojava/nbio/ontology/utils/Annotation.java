 ...
 * </p>
 * Other than when using the constructor, you should be able to interact with
 * nearly all Annotation implementations via this API.
 *
...
public interface Annotation {
	 ...
	 * </p>
	 *
	 * Be careful when stooring Annotation arguments to constructors. It is possible
	 * that you have been passed EMPTY_ANNOTATION but that code later on will access
	 * this object believing it to be mutable. For example, the SeqIO factory code
	 * clones some Annotations passed in on Feature.Template instances
	 *
	 ...
	 * </p>
	 * Normal raw access to the property. For cleverer access, use methods in
	 * AnnotationType.
	 *
	 ...
	 *
	 * <p>
	 * This method throws an exception if either properties can not be added to this
	 * object, or that this particular property is immutable or illegal within the
	 * implementation.
	 * </p>
	 * Normal raw access to the property. For cleverer access, use methods in
	 * AnnotationType.
	 ...
	 *                                  legal
	 * @throws ChangeVetoException      if this annotation object can't be changed,
	 *                                  or if the change was vetoed.
	 */
	void setProperty(Object key, Object value);

	/**
	 * Delete a property. Normal raw access to the property. For cleverer access,
	 * use methods in AnnotationType.
	 *
	 * @param key the key object
	...
	/**
	 * Returns whether there the property is defined. Normal raw access to the
	 * property. For cleverer access, use methods in AnnotationType.
	 *
	 ...
	 * <p>
	 * If the annotation changes, the map may not reflect this. The Map may be
	 * unmodifiable.
	 *
	 * @return a Map
	 */
