...
public class Synonym implements Comparable<Synonym> {
	...
	public final static Comparator<Synonym> COMPARATOR = (Synonym a, Synonym b) -> {
		if (a == null && b == null) {
			return 0;
		} else if (a == null) {
			return -1;
	...
	public String toString() {
		String txt = new StringBuilder().append("Synonym: name:").append(name).append(" category:").append(category)
