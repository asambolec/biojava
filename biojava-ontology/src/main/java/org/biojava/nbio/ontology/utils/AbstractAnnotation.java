...
public abstract class AbstractAnnotation
	 ...
	 *
	 * <p>
	 * This does a shallow copy of the annotation. The result is an annotation with
	 * the same properties and values, but which is independant of the original
	 * annotation.
	 * </p>
	 *
	 ...
	 *
	 * From code in the 1.2 version of AbstractAnnotation This is required for the
	 * implementation of an Annotation that extends AbstractAnnotation. Where
	 * possible implementations should be backed with a <code>LinkedHashMap</code>
	 * or similar so properties are iterated in the order they were added.
	 *
	...
	/**
	 * A convenience method to see if we have allocated the properties Map. This is
	 * required for the implementation of an Annotation that extends
	 * AbstractAnnotation.
	 * 
	...
	public Object getProperty(Object key) {
		...
		throw new NoSuchElementException(
				new StringBuilder().append("Property ").append(key).append(" unknown").toString());
	}
