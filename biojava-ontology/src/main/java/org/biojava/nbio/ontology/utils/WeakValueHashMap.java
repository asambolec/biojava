...
/**
 * Map implementation which keeps weak references to values. Entries are removed
 * from the map when their value is no longer reachable using normal (hard)
 * references. This is useful for maintaining canonical copies of objects
 * without forcing these objects to remain in memory forever.
 *
 * <p>
