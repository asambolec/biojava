 ...
 * perform generic implementations of algorithms using the Ontology interface to
 * get the same result. Ontology instances provide an instance of OntologyOps,
 * publishing optimizations of some common operations. The reasoner may then
 * choose to call OntologyOps methods on the Ontology instance rather than using
 * its fall-back implementations.
 * </p>
 *
