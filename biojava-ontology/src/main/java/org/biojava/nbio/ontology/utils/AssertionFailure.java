 ...
 * error condition. Assertion failures indicate that something has gone badly
 * wrong, and that the assumptions under which library code has been developed
 * are not holding.
 * </p>
 *
 * <p>
 * This extends {@link java.lang.AssertionError}, adding convenient constructors
 * with messages and causes.
 * </p>
 *
 *
 * Your application may exit due to one of these being thrown. This usualy
 * indicates that something is badly wrong with library code. It should never be
 * raised in response to invalid arguments to methods, or incorrectly formatted
 * data. It is not your fault. Report the error to the mailing list, or who ever
 * else is responsible for the library code you are using.
 *
 *
 ...
 * you are working with, and somewhere further down an IllegalSymbolException is
 * raised, then this is an assertion failure.
 *
