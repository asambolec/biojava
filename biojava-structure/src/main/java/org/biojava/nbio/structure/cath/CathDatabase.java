...
public interface CathDatabase {
	...
	/**
	 * Return list of CATH descriptions for node representatives at a CATH category
	 * (e.g. "T").
	 *
	 * @param category
	...
	/**
	 * Return list of CATH descriptions whose CATH codes (e.g. 1.4.6.10) start with
	 * the query. This is currently redundant with getDescriptionsByNodeId.
	 *
	 * @param query
	 * @return CATH descriptions
	 */
	...
	/**
	 * Return list of CATH domains whose node name (e.g. Orthogonal Bundle) starts
	 * with the query.
	 *
	 * @param query
	 * @return CATH domains
	...
	/**
	 * Return list of CATH descriptions whose descriptions (name field) starts with
	 * the query.
	 *
	 * @param query
	 * @return CATH descriptions
