...
/**
 * This is based on the original Combinatorial Extension (CE) source code from
 * 2003 or 2004 (CE version 2.3), as has been originally developed by I.
 * Shindyalov and P.Bourne (1998). The original CE paper is available from here:
 * <a href=
 * "http://peds.oxfordjournals.org/cgi/content/short/11/9/739">http://peds.oxfordjournals.org/cgi/content/short/11/9/739</a>.
 *
 * This class is a pretty much exact 1:1 port from C, where I cared about exact
 * reproduce of the CE results and not about Java style.
 *
...
public class CeCalculatorEnhanced {
	...
	private static final double[] scoreAv8 = { 2.54, 2.51, 2.72, 3.01, 3.31, 3.61, 3.90, 4.19, 4.47, 4.74, 4.99, 5.22,
			5.46, 5.70, 5.94, 6.13, 6.36, 6.52, 6.68, 6.91 };
	private static final double[] scoreSd8 = { 1.33, 0.88, 0.73, 0.71, 0.74, 0.80, 0.86, 0.92, 0.98, 1.04, 1.08, 1.10,
			1.15, 1.19, 1.23, 1.25, 1.32, 1.34, 1.36, 1.45 };
	private static final double[] gapsAv8 = { 0.00, 11.50, 23.32, 35.95, 49.02, 62.44, 76.28, 90.26, 104.86, 119.97,
			134.86, 150.54, 164.86, 179.57, 194.39, 209.38, 224.74, 238.96, 253.72, 270.79 };
	private static final double[] gapsSd8 = { 0.00, 9.88, 14.34, 17.99, 21.10, 23.89, 26.55, 29.00, 31.11, 33.10, 35.02,
			36.03, 37.19, 38.82, 41.04, 43.35, 45.45, 48.41, 50.87, 52.27 };
	private static final double[] scoreAv6 = { 1.98, 1.97, 2.22, 2.54, 2.87, 3.18, 3.48, 3.77, 4.05, 4.31, 4.57, 4.82,
			5.03, 5.24, 5.43, 5.64, 5.82, 6.02, 6.21, 6.42 };
	private static final double[] scoreSd6 = { 1.15, 0.73, 0.63, 0.64, 0.71, 0.80, 0.87, 0.95, 1.01, 1.07, 1.13, 1.19,
			1.22, 1.25, 1.28, 1.32, 1.35, 1.39, 1.45, 1.50 };
	private static final double[] gapsAv6 = { 0.00, 10.12, 20.25, 31.29, 42.95, 55.20, 67.53, 80.15, 93.30, 106.47,
			120.52, 134.38, 148.59, 162.58, 176.64, 191.23, 204.12, 218.64, 231.82, 243.43 };
	private static final double[] gapsSd6 = { 0.00, 9.80, 14.44, 18.14, 21.35, 24.37, 27.00, 29.68, 32.22, 34.37, 36.65,
			38.63, 40.31, 42.16, 43.78, 44.98, 47.08, 49.09, 50.78, 52.15 };
	private static final double[] tableZtoP = { 1.0, 9.20e-01, 8.41e-01, 7.64e-01, 6.89e-01, 6.17e-01, 5.49e-01,
			4.84e-01, 4.24e-01, 3.68e-01, 3.17e-01, 2.71e-01, 2.30e-01, 1.94e-01, 1.62e-01, 1.34e-01, 1.10e-01,
			8.91e-02, 7.19e-02, 5.74e-02, 4.55e-02, 3.57e-02, 2.78e-02, 2.14e-02, 1.64e-02, 1.24e-02, 9.32e-03,
			6.93e-03, 5.11e-03, 3.73e-03, 2.70e-03, 1.94e-03, 1.37e-03, 9.67e-04, 6.74e-04, 4.65e-04, 3.18e-04,
			2.16e-04, 1.45e-04, 9.62e-05, 6.33e-05, 4.13e-05, 2.67e-05, 1.71e-05, 1.08e-05, 6.80e-06, 4.22e-06,
			2.60e-06, 1.59e-06, 9.58e-07, 5.73e-07, 3.40e-07, 1.99e-07, 1.16e-07, 6.66e-08, 3.80e-08, 2.14e-08,
			1.20e-08, 6.63e-09, 3.64e-09, 1.97e-09, 1.06e-09, 5.65e-10, 2.98e-10, 1.55e-10, 8.03e-11, 4.11e-11,
			2.08e-11, 1.05e-11, 5.20e-12, 2.56e-12, 1.25e-12, 6.02e-13, 2.88e-13, 1.36e-13, 6.38e-14, 2.96e-14,
			1.36e-14, 6.19e-15, 2.79e-15, 1.24e-15, 5.50e-16, 2.40e-16, 1.04e-16, 4.46e-17, 1.90e-17, 7.97e-18,
			3.32e-18, 1.37e-18, 5.58e-19, 2.26e-19, 9.03e-20, 3.58e-20, 1.40e-20, 5.46e-21, 2.10e-21, 7.99e-22,
			3.02e-22, 1.13e-22, 4.16e-23, 1.52e-23, 5.52e-24, 1.98e-24, 7.05e-25, 2.48e-25, 8.64e-26, 2.98e-26,
			1.02e-26, 3.44e-27, 1.15e-27, 3.82e-28, 1.25e-28, 4.08e-29, 1.31e-29, 4.18e-30, 1.32e-30, 4.12e-31,
			1.27e-31, 3.90e-32, 1.18e-32, 3.55e-33, 1.06e-33, 3.11e-34, 9.06e-35, 2.61e-35, 7.47e-36, 2.11e-36,
			5.91e-37, 1.64e-37, 4.50e-38, 1.22e-38, 3.29e-39, 8.77e-40, 2.31e-40, 6.05e-41, 1.56e-41, 4.00e-42,
			1.02e-42, 2.55e-43, 6.33e-44, 1.56e-44, 3.80e-45, 9.16e-46, 2.19e-46, 5.17e-47, 1.21e-47, 2.81e-48,
			6.45e-49, 1.46e-49, 3.30e-50 };
	private static final double[] tablePtoZ = { 0.00, 0.73, 1.24, 1.64, 1.99, 2.30, 2.58, 2.83, 3.07, 3.29, 3.50, 3.70,
			3.89, 4.07, 4.25, 4.42, 4.58, 4.74, 4.89, 5.04, 5.19, 5.33, 5.46, 5.60, 5.73, 5.86, 5.99, 6.11, 6.23, 6.35,
			6.47, 6.58, 6.70, 6.81, 6.92, 7.02, 7.13, 7.24, 7.34, 7.44, 7.54, 7.64, 7.74, 7.84, 7.93, 8.03, 8.12, 8.21,
			8.30, 8.40, 8.49, 8.57, 8.66, 8.75, 8.84, 8.92, 9.01, 9.09, 9.17, 9.25, 9.34, 9.42, 9.50, 9.58, 9.66, 9.73,
			9.81, 9.89, 9.97, 10.04, 10.12, 10.19, 10.27, 10.34, 10.41, 10.49, 10.56, 10.63, 10.70, 10.77, 10.84, 10.91,
			10.98, 11.05, 11.12, 11.19, 11.26, 11.32, 11.39, 11.46, 11.52, 11.59, 11.66, 11.72, 11.79, 11.85, 11.91,
			11.98, 12.04, 12.10, 12.17, 12.23, 12.29, 12.35, 12.42, 12.48, 12.54, 12.60, 12.66, 12.72, 12.78, 12.84,
			12.90, 12.96, 13.02, 13.07, 13.13, 13.19, 13.25, 13.31, 13.36, 13.42, 13.48, 13.53, 13.59, 13.65, 13.70,
			13.76, 13.81, 13.87, 13.92, 13.98, 14.03, 14.09, 14.14, 14.19, 14.25, 14.30, 14.35, 14.41, 14.46, 14.51,
			14.57, 14.62, 14.67, 14.72, 14.77, 14.83, 14.88, 14.93 };
	int[] f1;
	int[] f2;
	double[][] dist1;
	double[][] dist2;
	...
	/**
	 * Evaluates the distance between two atoms Several scoring functions are
	 * implemented and can be changed by calling
	 * {@link CeParameters#setScoringStrategy(Integer) setScoringStrategy()} on
	 * {@link CeParameters parameter} object this CECalculator was created with.
	 * <p>
	 * Scoring Strategies:
	 * <dl>
	 ...
	 * <dd>A mix between the DEFAULT_SCORING_STRATEGY and a scoring function that
	 * favors the alignment of sequence conserved positions in the alignment</dd>
	 * </dl>
	 *
	 *
	 *
	...
	public double[][] initSumOfDistances(int nse1, int nse2, int winSize, int winSizeComb1, Atom[] ca1, Atom[] ca2) {
		...
		// at this stage mat contains the sum of the distances of fragments of the
		// matrices dist1, dist
			...
			for (int ise2 = 0; ise2 < nse2; ise2++) {
				...
				for (int is1 = 0; is1 < winSize - 2; is1++) {
					for (int is2 = is1 + 2; is2 < winSize; is2++) {
						// System.out.println("pos1 :" + (ise1+is1) + " " + (ise1+is2) + " " +
						// (ise2+is1) + " " + (ise2+is2));
	...
	public void traceFragmentMatrix(AFPChain afpChain, Atom[] ca1, Atom[] ca2) {
		...
		iterLoop: for (int iter = 0; iter < nIter; iter++) {
			...
			if (iter == 1) {
				z0 = zStrAlign(winSize, nBestTrace, bestTraceScore, bestTrace1[nBestTrace] + winSize - bestTrace1[0]
						+ bestTrace2[nBestTrace] + winSize - bestTrace2[0] - nBestTrace * 2 * winSize);
				if (z0 < zThr) {
					break;
				}
			...
			// System.out.println("ise1Loop: " + ise11 + " " + ise12 + " " + ise21 + " " +
			// ise22);
			ise1Loop: for (int ise1_ = ise11; ise1_ < ise12; ise1_++) {
				ise2Loop: for (int ise2_ = ise21; ise2_ < ise22; ise2_++) {
					...
					if (iter == 0
							&& (ise1 > nse1 - winSize * (nBestTrace - 1) || ise2 > nse2 - winSize * (nBestTrace - 1))) {
						continue ise2Loop;
					}
					...
					traceLoop: while (nTrace > 0) {
						...
						// System.out.println("isTraceUp " + isTraceUp + " " + nTrace + " " + kse1 + " "
						// + kse2);
						...
						if (isTraceUp) {
							...
							itLoop: for (int it = 0; it < iterDepth; it++) {
								...
								// if(!distAll) {
								// System.out.println("getting score " + mse1 + " " + mse2 + " " + winSize + " "
								// + jgap + " " + jdir + " " + it + " " + kse1 + " " + kse2);
								...
								// System.out.println("up: " + nTrace + " " + score + " " + score0 + " " +
								// score1 + " " + winSize + " " + traceIndex_ + " " + it + " ");
								...
								if (nTrace > nBestExtTrace || (nTrace == nBestExtTrace && score2 < bestExtScore)) {
						...
						if (traceIndex_ != -1) {
							...
							if (iter == 0) {
								...
								score1 = (traceScore[nTrace - 1][traceIndex_] * winSizeComb2 * nTrace
										+ mat[jse1][jse2] * winSizeComb1) / (winSizeComb2 * nTrace + winSizeComb1);

								score2 = getScore2(jse1, jse2, traceScore, traceIndex_, traceIndex, winSizeComb1,
						...
						// System.out.println("middle: " + nTrace + " " + score + " " + score0 + " " +
						// score1 + " " + score2 + " " + traceIndex_);
						...
						if (traceIndex_ == -1) {
							...
							if (nTrace > nBestTrace || (nTrace == nBestTrace && bestTraceScore > traceTotalScore)) {
							...
							if (iter == 0) {
								// System.out.println("doing iter0 " + newBestTrace + " " + traceTotalScore + "
								// " + bestTracesMax);
	...
	protected double getScore2(int jse1, int jse2, double[][] traceScore, int traceIndex_, int[] traceIndex,
			int winSizeComb1, int winSizeComb2, double score0, double score1) {

		/*
		 * double score2= ((nTrace>1?traceScore[nTrace-2][traceIndex[nTrace-1]]:score0)
		...
		double score2 = (val * traceIndexContainer[nTrace - 1]
				+ score1 * (traceIndexContainer[nTrace] - traceIndexContainer[nTrace - 1]))
				/ traceIndexContainer[nTrace];

		// System.out.println("check: score0 " + score0 + " score 1 " + score1 + " sc2:
		// " + score2 + " val: " + val + " nTrace:" + nTrace+ " " +
		// traceIndexContainer[nTrace-1] + " " + traceIndexContainer[nTrace-1] + " " +
		// traceIndexContainer[nTrace] );
	...
	protected int doIter0(int newBestTrace, double traceTotalScore, double bestTracesMax) {
		...
		if (nTrace > bestTracesN[newBestTrace]
				|| (nTrace == bestTracesN[newBestTrace] && bestTracesScores[newBestTrace] > traceTotalScore)) {
			...
			if (nBestTraces == bestTracesMax) {
				...
				for (int ir = 1; ir < nBestTraces; ir++) {
					if (bestTracesN[ir] < nTraceTmp
							|| (bestTracesN[ir] == nTraceTmp && scoreTmp < bestTracesScores[ir])) {
		...
		// System.out.println("iter0 : " + newBestTrace + " " +
		// bestTracesN[newBestTrace] + " " + traceTotalScore + " " + nTrace);

		/*
		 * z=zStrAlign(winSize, nTrace, traceTotalScore,
		 * trace1[nTrace-1]-trace1[0]+trace2[nTrace-1]-trace2[0]- 2*(nTrace-1)*winSize);
		 * if(z>bestTraceZScore) { for(int itrace=0; itrace<nTrace; itrace++) {
		 * bestTrace1[itrace]=trace1[itrace]; bestTrace2[itrace]=trace2[itrace]; }
		 * bestTraceZScore=z; bestTraceScore=*(traceScore[nTrace-2]+traceIndex_);
		 * nBestTrace=nTrace; }
		 */
		return newBestTrace;
	...
	protected double getScoreFromDistanceMatrices(int mse1, int mse2, int winSize) {
		...
		for (int itrace = 0; itrace < nTrace; itrace++) {
			...
			score += Math.abs(dist1[trace1[itrace] + winSize - 1][mse1 + winSize - 1]
	...
	private void checkBestTraces(AFPChain afpChain, Atom[] ca1, Atom[] ca2) throws StructureException {
		...
		for (int ir = 0; ir < nBestTraces; ir++) {
			...
			rmsdNew = getRMSDForBestTrace(ir, strBuf1, strBuf2, bestTracesN, bestTraces1, bestTrace2, winSize, ca1,
					ca2);
			if (isPrint) {
		...
		// System.out.println("iBestTrace: "+iBestTrace+" = bestTracesScores " +
		// bestTracesScores[iBestTrace]);
		...
		outer_loop: for (int it = 1; it < nBestTrace; it++) {
			...
			main_loop: for (idir = -1; idir <= 1; idir += 2) {
				...
				inner_loop: for (int idep = 1; idep <= winSize / 2; idep++) {
					...
					// System.out.println(String.format("step %d %d %d %.2f old: %.2f", it, idir,
					// idep, rmsdNew, rmsd));
					if (rmsdNew < rmsd) {
		...
		if (isPrint) {
			logger.info(
					new StringBuilder().append("rmsdNew: ").append(rmsdNew).append(" rmsd ").append(rmsd).toString());
		}
		...
		logger.info(new StringBuilder().append("zStrAlign: ").append(winSize).append(" strLen ").append(strLen)
				.append(" s/w ").append(strLen / winSize).append(" ").append(bestTraceScore).append(" ").append(nGaps)
				.toString());
		z = zStrAlign(winSize, strLen / winSize, bestTraceScore, nGaps);

		if (params.isShowAFPRanges()) {
			logger.info(new StringBuilder().append("win size: ").append(winSize).append(" strLen/winSize: ")
					.append(strLen / winSize).append(" best trace score: ")
					.append(String.format("%.2f", bestTraceScore)).append(" nr gaps: ").append(nGaps)
					.append(" nr residues: ").append(nAtom).toString());

			logger.info(String.format("size=%d rmsd=%.2f z=%.1f gaps=%d(%.1f%%) comb=%d", nAtom, rmsd, z, nGaps,
					nGaps * 100.0 / nAtom, nTraces));

			logger.info("Best Trace, before optimization");
			for (int k = 0; k < nBestTrace; k++) {
				logger.info(String.format("(%d,%d,%d) ", bestTrace1[k] + 1, bestTrace2[k] + 1, bestTraceLen[k]));
			}
		...
		// System.out.println("z:"+z + " zThr" + zThr+ " bestTraceScore " +
		// bestTraceScore + " " + nGaps );
		if (z >= zThr) {
		...
		if (isPrint) {
			String msg = String.format("Alignment length = %d Rmsd = %.2fA Z-Score = %.1f Gaps = %d(%.1f%%)", nAtom,
					rmsd, z, nGaps, gapsP);
			logger.info(new StringBuilder().append(msg).append(" CPU = ").append(time_q).toString());
		}
	...
	/**
	 * set the Atoms for a particular residue position. Requires that atom.getParent
	 * returns the correct group! take care during cloning of atoms. Best to use
	 * StructureTools.cloneCaAtoms();
	 *
	 * @param strBuf
	 * @param i
	 * @param ca
	...
	private double getRMSDForBestTrace(int ir, Atom[] strBuf1, Atom[] strBuf2, int[] bestTracesN2, int[][] bestTraces12,
			int[] bestTrace22, int winSize, Atom[] ca1, Atom[] ca2) throws StructureException {
		int is = 0;
	...
	private int optimizeSuperposition(AFPChain afpChain, int nse1, int nse2, int strLen, double rmsd, Atom[] ca1,
			Atom[] ca2, int nGaps, Atom[] strBuf1, Atom[] strBuf2) throws StructureException {
		...
		// double[][] mat = new double[nse1][nse2];
		while ((nAtom < strLen * 0.95 || (isRmsdLenAssigned && rmsd < rmsdLen * 1.1 && nAtomPrev != nAtom))
				&& (counter < maxNrIterations)) {

			counter++;
			if (debug) {
				logger.info(new StringBuilder().append("nAtom: ").append(nAtom).append(" ").append(nAtomPrev)
						.append(" ").append(rmsdLen).append(" ").append(isRmsdLenAssigned).append(" strLen:")
						.append(strLen).append(" nse1,nse2:").append(nse1).append(" ").append(nse2).toString());
			}
			nAtomPrev = nAtom;
			...
			for (int ise1 = 0; ise1 < nse1; ise1++) {
				for (int ise2 = 0; ise2 < nse2; ise2++) {
					...
					// System.out.println("mat[" + ise1 + "][" + ise2 + "] " + mat[ise1][ise2] + "
					// scoreOld:" + scoreOld + " oRmsdThr: " + oRmsdThr +" dist: " + dist + "
					// distold:" + distold );
					// }
			...
			if (debug) {
				logger.info(new StringBuilder().append("iter: ").append(counter).append("  score:").append(score)
						.append(" ").append(" nAtomPrev: ").append(nAtomPrev).append(" nAtom:").append(nAtom)
						.append(" oRmsdThr: ").append(oRmsdThr).toString());

				for (int i = 0; i < alignmentPositionOrLength; i++) {
					if (align_se2[i] == 172 || align_se2[i] == 173) {
						logger.info("BREAK POINT IS ALIGNED!!!!");
						logger.info(new StringBuilder().append(align_se2[i - 1]).append(" ").append(align_se2[i])
								.append(" ").append(align_se2[i + 1]).toString());
					}
				}
			}
			...
			for (Atom aStrBuf1 : strBuf1) {
				if (aStrBuf1 == null) {
					break;
				}
				logger.info(aStrBuf1.getGroup().getChemComp().getOne_letter_code());
			}
			System.out.println();
			...
			if (isPrint) {
				logger.info(new StringBuilder().append("iter: ").append(counter).append(" nAtom ").append(nAtom)
						.append(" rmsd: ").append(rmsd).toString());
			...
			// System.out.println(String.format("nAtom %d %d rmsd %.1f", nAtom, nAtomPrev,
			// rmsd));
		...
		/*
		 * nAtom=0; nGaps=0; for(int ia=0; ia<lcmp; ia++) if(align_se1[ia]!=-1 &&
		 * align_se2[ia]!=-1) { if(ca1[align_se1[ia]].X<1e10 &&
		 * ca2[align_se2[ia]].X<1e10) { strBuf1[nAtom]=ca1[align_se1[ia]];
		 * strBuf2[nAtom]=ca2[align_se2[ia]]; nAtom++; } } else { nGaps++; }
		 * 
		 * sup_str(strBuf1, strBuf2, nAtom, _d); rmsd=calc_rmsd(strBuf1, strBuf2, nAtom,
		 * _d);
		 */
		nBestTrace = 0;
	 ...
	 */
	public static double[][] updateMatrixWithSequenceConservation(double[][] max, Atom[] ca1, Atom[] ca2,
			CeParameters params) {
		...
		for (int i = 0; i < origM.getRowDimension(); i++) {
			for (int j = 0; j < origM.getColumnDimension(); j++) {
				...
				AminoAcidCompound ac1 = set.getCompoundForString(a1.getGroup().getChemComp().getOne_letter_code());
				AminoAcidCompound ac2 = set.getCompoundForString(a2.getGroup().getChemComp().getOne_letter_code());
	...
	private double dpAlign(int nSeq1, int nSeq2, double gapI, double gapE, boolean isGlobal1, boolean isGlobal2) {
		...
		// ge = true here...
		/*
		 * for(i=0; i<nSeq1; i++) { printf("\n"); for(j=0; j<nSeq2; j++) { printf("%4d",
		 * (int)(*(mat[i]+j)*10)); } } printf("\n\n\n");
		 */
				...
				for (j = nSeq2 - 1; j >= 0; j--) {
					...
					if (j < nSeq2 - 1 && i < nSeq1 - 1) {
						...
						if (isGlobal1 && i != nSeq1 - 1) {
							maxSum = -gapI - gapE * (nSeq1 - i - 1);
						}
						if (isGlobal2 && j != nSeq2 - 1) {
							maxSum = -gapI - gapE * (nSeq2 - j - 1);
						}
		...
		// ok we got the maximum score in sum_ret and the start position in iStart,
		// jStart
		...
		for (i = iStart, j = jStart; i < nSeq1 && j < nSeq2; i++, j++) {
			...
			if (!hasGapExtensionPenalty) {
				...
				for (k = i + 1; k < nSeq1; k++) {
					if (mat[k][j] - gapI - gapE * (k - i) > localMaxScore) {
						logger.info(new StringBuilder().append("     gap1 ").append(alignmentPositionOrLength)
								.append(" ").append(k).append(" ").append(j).append(" ").append(localMaxScore)
								.append("<").append(mat[k][j] - gapI - gapE * (k - i)).toString());
						iMax = k;
						jMax = j;
				...
				for (k = j + 1; k < nSeq2; k++) {
					if (mat[i][k] - gapI - gapE * (k - j) > localMaxScore) {
						logger.info(new StringBuilder().append("     gap2 ").append(alignmentPositionOrLength)
								.append(" ").append(k).append(" ").append(i).append(" ").append(localMaxScore)
								.append("<").append(mat[i][k] - gapI - gapE * (k - j)).toString());
						iMax = i;
						jMax = k;
			...
			if (i != iMax || j != jMax) {
				int l1 = iMax - i;
				int l2 = jMax - j;
				logger.info(String.format("FOUND GAP AT: lcmp:%d l1: %d l2: %d | i:%d iMax: %d j:%d jMax:%d ",
						alignmentPositionOrLength, l1, l2, i, iMax, j, jMax));
				if (l1 > 0) {
					logger.info(new StringBuilder().append(" -- G1 : ").append(alignmentPositionOrLength).append(" ->")
							.append(alignmentPositionOrLength + l1).append(" ").toString());
					gapPosition = true;
				}
				if (l2 > 0) {
					logger.info(new StringBuilder().append(" -- G2 : ").append(alignmentPositionOrLength).append(" ->")
							.append(alignmentPositionOrLength + l2).append(" ").toString());
					gapPosition = true;
				}
				if (prevGapEnd == alignmentPositionOrLength - 1) {
					// double gap!
					logger.info(
							new StringBuilder().append("  !! FOUND DOUBLE GAP AT: ").append(alignmentPositionOrLength)
									.append(" | ").append(i).append(" ").append(iMax).append(" ").append(j).append(" ")
									.append(jMax).append(" ").append(String.format("%f", mat[i][j])).append(" ")
									.append(getTraceBack(tracebackMatrix1, tracebackMatrix2, i, j)).toString());
					// doubleGap = true;
			...
			logger.info(String.format("  lcmp:%d i:%d j:%d imax:%d jmax:%d score: %.2f", alignmentPositionOrLength, i,
					j, iMax, jMax, mat[iMax][jMax]));
			...
			if (brk_flg[i][j]) {
				// System.out.println("hit break flag at: " + i + " " + j + " sum " + sum_ret +
				// " lcmp " + alignmentPositionOrLength);
				break;
	...
	private String getTraceBack(int[][] tracebackMatrix1, int[][] tracebackMatrix2, int i, int j) {
		...
		String s = new StringBuilder().append("[ ").append(t1).append(",").append(t2).append("] ").toString();
	...
	public double calc_rmsd(Atom[] pro1, Atom[] pro2, int strLen, boolean storeTransform, boolean show)
		...
		//
		// jmol.setAtoms(cod1);
		// jmol.evalString("select * ; wireframe off; spacefill off; backbone on; color
		// chain; select ligand;color cpk; wireframe 40;spacefill 120; ");
		// jmol.setTitle("calCaRmsd - pdb1");
		//
		// StructureAlignmentJmol jmol2 = new StructureAlignmentJmol();
		// jmol2.setAtoms(cod2);
		// jmol2.evalString("select * ; wireframe off; spacefill off; backbone on; color
		// chain; select ligand;color cpk; wireframe 40;spacefill 120; ");
	 ...
	 * @return An array with the first length items of ca, possibly cloning the
	 *         Atoms.
	 * @throws StructureException
	 */
	...
	private void noBestTrace() {
		...
		timeEnd = System.currentTimeMillis();
		long time_q = (timeEnd - timeStart);
		String msg = String.format("size=0 time=%d comb=%d%n", (int) (time_q), nTraces);
		logger.info(msg);
	}
	...
	public void convertAfpChain(AFPChain afpChain, Atom[] ca1, Atom[] ca2) {
		...
		for (int ia = 0; ia < alignmentPositionOrLength; ia++) {
			...
			// no gap
			if (align_se1[ia] != -1 && align_se2[ia] != -1) {
				// System.out.println("ia " + ia + " pos " + pos + " " + align_se1[ia] + " " +
				// align_se2[ia]);
		...
		// CE uses the aligned pairs as reference not the whole alignment including
		// gaps...
		if (pos > 0) {
	...
	/**
	 * Caution: this matrix is overwriten with very different data at several points
	 * in the alignment algorithm. After
	 * {@link #initSumOfDistances(int, int, int, int, Atom[], Atom[])
	 * initSumOfDistances} is run, this will hold the distance matrix between AFPs.
	 * 
	 * @return mat
	 */
