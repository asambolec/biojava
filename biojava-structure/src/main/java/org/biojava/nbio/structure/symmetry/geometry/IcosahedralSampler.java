 ...
 * @author Peter
 */
// This would be better named HexacosichoronSampler, since it's sampling 4D
// space. -SB
public final class IcosahedralSampler {
	...
	// orientations cover an equal fraction of orientation space and have equal
	// weight.
	private static double[][] orientations = { { 1.000000000f, 0.000000000f, 0.000000000f, 0.000000000f, 1.000000f },
