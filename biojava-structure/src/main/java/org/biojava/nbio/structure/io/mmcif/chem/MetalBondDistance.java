...
/**
 * A bean that contains cutoffs for correctly detecting metal bonds. Definitions
 * are in file bond_distance_limits.cif.gz
 *
...
public class MetalBondDistance {
	...
	public String toString() {
		return new StringBuilder().append("MetalBindDistance{").append("atomType1='").append(atomType1).append('\'')
				.append(", atomType2='").append(atomType2).append('\'').append(", lowerLimit=").append(lowerLimit)
				.append(", upperLimit=").append(upperLimit).append('}').toString();
	}
}
