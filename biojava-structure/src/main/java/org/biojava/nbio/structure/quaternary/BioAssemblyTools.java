...
public class BioAssemblyTools {
	...
	private static final Logger logger = LoggerFactory.getLogger(BioAssemblyTools.class);

	/**
	 * Checks if the passed in expression is a unary operator expression Example:
	 * (1,2,3) or (1-60) are unary operator expressions (1-60)(61-88) is a binary
	 * operator expression, representing a cartesian product of the two
	 * parenthesised lists
	 *
	 * @param expression
	...
	public static double[][] getBiologicalMoleculeBounds(Structure asymStructure,
	...
	/**
	 * Returns the maximum extend of the biological molecule in the x, y, or z
	 * direction.
	 * 
	 * @param structure
	 * @return maximum extend
	...
	public static double[] getBiologicalMoleculeCentroid(final Structure asymUnit,
			List<BiologicalAssemblyTransformation> transformations) {
		if (asymUnit == null) {
