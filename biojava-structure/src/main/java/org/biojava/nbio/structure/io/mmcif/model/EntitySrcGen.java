...
public class EntitySrcGen {
	...
	public void setPdbx_gene_src_cellular_location(String pdbx_gene_src_cellular_location) {
	...
	public void setPdbx_gene_src_ncbi_taxonomy_id(String pdbx_gene_src_ncbi_taxonomy_id) {
	...
	public void setPdbx_gene_src_scientific_name(String pdbx_gene_src_scientific_name) {
	...
	public void setPdbx_host_org_cellular_location(String pdbx_host_org_cellular_location) {
	...
	public void setPdbx_host_org_culture_collection(String pdbx_host_org_culture_collection) {
	...
	public void setPdbx_host_org_ncbi_taxonomy_id(String pdbx_host_org_ncbi_taxonomy_id) {
	...
	public void setPdbx_host_org_scientific_name(String pdbx_host_org_scientific_name) {
	...
	public void setPdbx_host_org_tissue_fraction(String pdbx_host_org_tissue_fraction) {
