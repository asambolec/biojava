...
public class SiftsResidue implements Serializable {
	...
	public String toString() {
		return new StringBuilder().append("SiftsResidue [pdbResNum=").append(pdbResNum).append(", pdbResName=")
				.append(pdbResName).append(", chainName=").append(chainId).append(", uniProtResName=")
				.append(uniProtResName).append(", uniProtPos=").append(uniProtPos).append(", naturalPos=")
				.append(naturalPos).append(", seqResName=").append(seqResName).append(", pdbId=").append(pdbId)
				.append(", uniProtAccessionId=").append(uniProtAccessionId).append(", notObserved=").append(notObserved)
				.append("]").toString();
	}
	...
	public boolean equals(Object obj) {
		...
		if (naturalPos == null) {
			if (other.naturalPos != null) {
				return false;
			}
		} else if (!naturalPos.equals(other.naturalPos)) {
			return false;
		}
		if (notObserved == null) {
			if (other.notObserved != null) {
				return false;
			}
		} else if (!notObserved.equals(other.notObserved)) {
			return false;
		}
		if (pdbId == null) {
			if (other.pdbId != null) {
		...
		if (seqResName == null) {
			if (other.seqResName != null) {
				return false;
			}
		} else if (!seqResName.equals(other.seqResName)) {
			return false;
		}
