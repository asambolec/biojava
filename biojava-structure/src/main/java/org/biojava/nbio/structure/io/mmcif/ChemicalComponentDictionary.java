 ...
 * @since 1.7
 * @see <a href="http://mmcif.rcsb.org/dictionaries/">link into mmCIF
 *      dictionary</a>
 *
 */
public class ChemicalComponentDictionary {
	...
	/**
	 * if ChemComp is replaced by another one, get the newer version otherwise
	 * return the same ChemComp again.
	 * 
	 * @param c
	...
	/**
	 * if ChemComp is replacing another one, get the old version otherwise return
	 * the same ChemComp again.
	 * 
