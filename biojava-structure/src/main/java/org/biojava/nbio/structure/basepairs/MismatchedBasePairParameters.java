...
/**
 * This class allows for finding inter-strand base pairs that are not
 * necessarily canonical Watson-Crick pairs. The implementation of findPair is
 * different than that of the base class. This class does not consider
 * intra-strand base pairing and for that, the TertiaryBasePairParameters class
 * should be used.
 * 
 * @author Luke Czapla
 * @since 5.0.0
...
public class MismatchedBasePairParameters extends BasePairParameters {
	...
	private double maxShear = DEFAULT_MAX_SHEAR;

	private double maxStretch = DEFAULT_MAX_STRETCH;

	private double maxPropeller = DEFAULT_MAX_PROPELLER;

	/**
	 * This constructor is used to create the TertiaryBasePairParameters object. The
	 * parent constructors are valid as well, but for this class, it makes the most
	 * sense to specify the exact parameters for the analysis.
	 * 
	 * @param structure  The Structure to analyze
	 * @param RNA        Whether to analyze RNA (if false, it will analyze DNA)
	 * @param removeDups Whether to remove duplicate sequences (useful for RCSB data
	 *                   with redundant units).
	 * @param canonical  Whether to only consider canonical Watson-Crick base pairs.
	 *                   If false, any pairing will be identified as long it falls
	 *                   below the maximum values of stagger, shear, and stretch.
	 */
	...
	/**
	 * This is an implementation for finding non-canonical base pairs when there may
	 * be missing or overhanging bases.
	 * 
	 * @param chains The list of chains already found to be nucleic acids.
	 * @return The list of the atom groups (residues) that are pairs, as a Pair of
	 *         nucleic acid Groups.
	 */
	@Override
	...
	/**
	 * This method returns the maximum stagger between bases used as criteria for
	 * the characterization of two bases as being paired.
	 * 
	...
	/**
	 * This method sets the maximum stagger allowed for a base pair, prior to
	 * analyze() call
	 * 
	 * @param maxStagger The maximum propeller (in Å) allowed to consider two bases
	 *                   paired
	 */
	...
	/**
	 * This method returns the maximum shear between bases used as criteria for the
	 * characterization of two bases as being paired.
	 * 
	...
	/**
	 * This method sets the maximum shear allowed for a base pair, prior to
	 * analyze() call
	 * 
	...
	/**
	 * This method returns the maximum stretch between bases used as criteria for
	 * the characterization of two bases as being paired.
	 * 
	...
	/**
	 * This method sets the maximum stretch allowed for a base pair, prior to
	 * analyze() call.
	 * 
	 * @param maxStretch The maximum stretch (in Å) allowed to consider two bases
	 *                   paired
	 */
	...
	/**
	 * This method returns the maximum propeller twist between bases used as
	 * criteria for the characterization of two bases as being paired.
	 * 
	 * @return the maximum propeller ("propeller-twist", in degrees) allowed.
	 */
	...
	/**
	 * This method sets the maximum propeller allowed for a base pair, prior to
	 * analyze() call
	 * 
	 * @param maxPropeller The maximum propeller ("propeller-twist", in degrees)
	 *                     allowed to consider two bases paired
	 */
