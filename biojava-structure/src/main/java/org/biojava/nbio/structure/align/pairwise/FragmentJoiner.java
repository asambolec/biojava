...
public class FragmentJoiner {
	...
	/**
	 * In helices often many similar fragments can be found. To reduce these to a
	 * few representative ones this check can be used. It does a distance check
	 * between all known Fragments and a new one. If this one is on a similar
	 * diagonal and it has a lower rms, this one is a better representation. Note:
	 * shifts of one are not allowed.
	 *
	 * @param fragments
	 * @param f
	 * @param rmsmat
	 * @return true - if this is a better representant for a group of locala
	 *         fragments.
	 */
	...
	public JointFragments[] approach_ap3(Atom[] ca1, Atom[] ca2, FragmentPair[] fraglst, StrucAligParameters params)
	...
	private boolean densityCheckOk(Atom[] aa1, Atom[] aa2, List<int[]> idxlist, int p2i, int p2j, int l2,
	 ...
	 * @param frag the JointFragments object that contains the list of identical
	 *             positions
	 * @return the rms
	 */
	...
	/**
	 * Calculate the pairwise compatibility of fpairs. Iterates through a list of
	 * fpairs and joins them if they have compatible rotation and translation
	 * parameters.
	 * 
	 ...
	 */
	public JointFragments[] frag_pairwise_compat(FragmentPair[] fraglst, int angleDiff, float fragCompatDist,
			int maxRefine) {
...
class JointFragmentsComparator implements Comparator<JointFragments>, Serializable {
