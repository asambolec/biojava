...
public class ResidueNumber implements Serializable, Comparable<ResidueNumber> {
	...
	private static final Logger logger = LoggerFactory.getLogger(ResidueNumber.class);
	...
	/**
	 * Convert a string representation of a residue number to a residue number
	 * object. The string representation can be a integer followed by a character.
	 *
	 * @param pdb_code
	...
	/**
	 * Compare residue numbers by sequence number and insertion code, ignoring the
	 * chain
	 * 
	 * @param other
	 * @return
	...
	public String printFull() {
		...
		return new StringBuilder().append(chain).append("_").append(toString()).toString();
	}
