...
/**
 * Provides programmatic access to ASTRAL representative sets. See the paper by
 * <a href="http://scop.berkeley.edu/references/2004-nar-astral.pdf">Chandonia
 * et. al.</a> for more information. Example:
 *
 * <pre>
 * Set&lt;String&gt; astralSet = Astral.getRepresentatives(Astral.AstralSet.NINETY_FIVE_175B);
 * </pre>
 *
 * This class uses a multiton pattern with soft references for caching. In
 * short: the first time you call the above, it will fetch the data from ASTRAL;
 * the second time will (probably) not have to; and the instances can still be
 * garbage-collected if necessary (meaning they don't <em>require</em> heap
 * memory).
 *
 * @author dmyerstu
 * @since 3.0.6
...
public class Astral {
	 ...
	 * {@link #getRepresentatives(AstralSet)} instead. This constructor should only
	 * be used when an ASTRAL set not included in {@link #Astral(AstralSet)} is
	 * required.
	 *
	 * @param cutoff The ASTRAL sequence-identity cutoff required
	 * @throws RuntimeException If the Astral set could not be parsed or accessed
	 *                          for any reason
	 */
	 ...
	 * 
	 * @return A LinkedHashMap mapping line numbers of failures to the lines
	 *         themselves
	 */
	 ...
	 * Every character before the first whitespace character of each header in the
	 * FASTA file is expected to be a representative's name.
	 *
	...
	public static enum AstralSet {
		FORTY_175("1.75_40",
				"http://scop.berkeley.edu/downloads/scopseq-1.75/astral-scopdom-seqres-gd-sel-gs-bib-40-1.75.fa"),
		NINETY_FIVE_175("1.75_95",
				"http://scop.berkeley.edu/downloads/scopseq-1.75/astral-scopdom-seqres-gd-sel-gs-bib-95-1.75.fa"),
		FORTY_175A("1.75A_40",
				"http://scop.berkeley.edu/downloads/scopeseq-2.01/astral-scopedom-seqres-gd-sel-gs-bib-40-2.01.fa"),
		NINETY_FIVE_175A("1.75A_95",
				"http://scop.berkeley.edu/downloads/scopeseq-2.01/astral-scopedom-seqres-gd-sel-gs-bib-95-2.01.fa"),
		FORTY_175B("1.75B_40",
				"http://scop.berkeley.edu/downloads/scopeseq-2.02/astral-scopedom-seqres-gd-sel-gs-bib-40-2.02.fa"),
		NINETY_FIVE_175B("1.75B_95",
				"http://scop.berkeley.edu/downloads/scopeseq-2.02/astral-scopedom-seqres-gd-sel-gs-bib-95-2.02.fa"),
		FORTY_201("2.01_40",
				"http://scop.berkeley.edu/downloads/scopeseq-2.01/astral-scopedom-seqres-gd-sel-gs-bib-40-2.01.fa"),
		NINETY_FIVE_201("2.01_95",
				"http://scop.berkeley.edu/downloads/scopeseq-2.01/astral-scopedom-seqres-gd-sel-gs-bib-95-2.01.fa"),
		FORTY_202("2.02_40",
				"http://scop.berkeley.edu/downloads/scopeseq-2.02/astral-scopedom-seqres-gd-sel-gs-bib-40-2.02.fa"),
		NINETY_FIVE_202("2.02_95",
				"http://scop.berkeley.edu/downloads/scopeseq-2.02/astral-scopedom-seqres-gd-sel-gs-bib-95-2.02.fa"),
		FORTY_203("2.03_40",
				"http://scop.berkeley.edu/downloads/scopeseq-2.03/astral-scopedom-seqres-gd-sel-gs-bib-40-2.03.fa"),
		NINETY_FIVE_203("2.03_95",
				"http://scop.berkeley.edu/downloads/scopeseq-2.03/astral-scopedom-seqres-gd-sel-gs-bib-95-2.03.fa");
		private String id;
		private String url;
