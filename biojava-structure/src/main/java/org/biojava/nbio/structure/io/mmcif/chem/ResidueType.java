...
/**
 * Enumerates the possible classifications of residues. These are generally more
 * specific than PolymerTypes This information is derived from the mmcif
 * dictionary.
 * 
 * @author mulvaney
 * @author Andreas Prlic
 * @see <a href=
 *      "http://mmcif.rcsb.org/dictionaries/mmcif_pdbx.dic/Items/_chem_comp.type.html">link
...
public enum ResidueType implements Serializable {
	...
	lPeptideLinking(PolymerType.peptide, "L-peptide linking"), glycine(PolymerType.peptide, "PEPTIDE LINKING"),
	...
	// Nucleotides
	dnaLinking(PolymerType.dna, "DNA linking"), rnaLinking(PolymerType.rna, "RNA linking"),
	...
	// L nucleotides. As of 2015-04, these are only found in D-DNA hybrids, so they
	// don't have their own PolymerType
	lDNALinking(PolymerType.dna, "L-DNA linking"), lRNALinking(PolymerType.dna, "L-RNA linking"),
	// Other
	nonPolymer(null, "non-polymer"), otherChemComp(null, "other");
	...
	public static ResidueType getResidueTypeFromString(String chem_comp_type) {
		...
		// Almost all calls to this method are for L-peptide linking. Use this knowledge
		// for a shortcut.
		...
		/**
		 * Unfortunately it can be guaranteed that chem_comp_type case sensitivity is
		 * preserved. E.g. mmtf has it all upper-case. As such we need to do a second
		 * check
		 */
