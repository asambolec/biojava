...
public class Tetrahedron implements Polyhedron {
	...
	/**
	 * Returns the radius of a sphere, that is tangent to each of the tetrahedron's
	 * edges
	 *
	...
	public Matrix3d getViewMatrix(int index) {
		...
		case 0:
			...
			break;
		case 1:
			m.rotX(Math.PI); // back face-centered
			break;
		case 2:
			double angle = Math.PI - 0.5 * tetrahedralAngle; // Side edge-centered
			m.rotX(angle);
			break;
		default:
			throw new IllegalArgumentException("getViewMatrix: index out of range:" + index);
