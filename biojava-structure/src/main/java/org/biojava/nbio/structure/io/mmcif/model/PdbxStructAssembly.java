...
public class PdbxStructAssembly implements Serializable {
	...
	public String toString() {
		return new StringBuilder().append("PdbxStructAssembly [id=").append(id).append(", details=").append(details)
				.append(", method_details=").append(method_details).append(", oligomeric_details=")
				.append(oligomeric_details).append(", oligomeric_count=").append(oligomeric_count).append("]")
				.toString();
	}
