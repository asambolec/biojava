...
/**
 * Data items in the ENTITY_SRC_NAT category record details of the source from
 * which the entity was obtained in cases where the entity was isolated directly
 * from a natural tissue.
 */
