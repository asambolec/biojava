...
/**
 * Sorted symbol table implementation using a java.util.TreeMap. Does not allow
 * duplicate keys.
 *
...
public class SymbolTable<Key extends Comparable<Key>, Value> implements Iterable<Key>, Serializable {
	...
	/**
	 * Put key-value pair into the symbol table. Remove key from table if value is
	 * null.
	 */
	...
	/**
	 * Delete the key (and paired value) from table. Return the value paired with
	 * given key; null if key is not in table.
	 */
	...
	/**
	 * Return an <tt>Iterator</tt> for the keys in the table. To iterate over all of
	 * the keys in the symbol table <tt>st</tt>, use the foreach notation:
	 * <tt>for (Key key : st)</tt>.
	 */
	@Override
	...
	/**
	 * Return an <tt>Iterable</tt> for the keys in the table. To iterate over all of
	 * the keys in the symbol table <tt>st</tt>, use the foreach notation:
