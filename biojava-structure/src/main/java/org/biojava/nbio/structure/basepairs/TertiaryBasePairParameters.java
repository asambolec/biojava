...
/**
 * This class also finds the base pairing and base-pair step parameters but has
 * a broader definition of a base pair so that non-canonical-WC base pairs will
 * be detected and reported. This is useful for RNA that has folded into
 * different regions, and for higher-order DNA structures. Intra-strand pairings
 * are considered in this class (but in not the base class or
 * MismatchedBasePairParameters class)
 * 
 * @author Luke Czapla
 * @since 5.0.0
 *
...
public class TertiaryBasePairParameters extends BasePairParameters {
	...
	/**
	 * This is an alternative implementation of findPair() that looks for anything
	 * that would fit the criteria for a base-pair, useful for the context of
	 * tertiary structure of RNA. Intra-strand base pairs are found with this
	 * algorithm.
	 * 
	 * @param chains The list of chains already found to be nucleic acids
	 * @return A list of the Pair of groups that match the base pair criteria,
	 *         including intra-strand groups.
	 */
	@Override
	 ...
	 * analyze() call
	 * 
	 * @param maxStagger The maximum stagger (in Å) allowed to consider two bases
	 *                   paired
	 */
