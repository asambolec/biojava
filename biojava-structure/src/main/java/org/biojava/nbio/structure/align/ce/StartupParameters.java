...
public class StartupParameters {
	...
	/**
	 * mandatory argument to set the first PDB (and optionally chain ID) to be
	 * aligned.
	 *
	 * @param pdb1
	 */
	...
	/**
	 * mandatory argument to set the second PDB (and optionally chain ID) to be
	 * aligned.
	 * 
	 * @param pdb2
	 */
	...
	/**
	 * When writing the results to a file, don;t write as XML but write aligned PDB
	 * file
	 *
	 * @return flag
	 */
	...
	public String toString() {
		return new StringBuilder().append("StartupParameters [pdbFilePath=").append(pdbFilePath).append(", ")
				.append(newline).append(" cacheFilePath=").append(cacheFilePath).append(", ").append(newline)
				.append(" outFile=").append(outFile).append(", ").append(newline).append(" pdb1=").append(pdb1)
				.append(", ").append(newline).append(" pdb2=").append(pdb2).append(", ").append(newline)
				.append(" file1=").append(file1).append(", ").append(newline).append(" file2=").append(file2)
				.append(", ").append(newline).append(" showDBresult=").append(showDBresult).append(", ").append(newline)
				.append(" printXML=").append(printXML).append(", ").append(newline).append(" printFatCat=")
				.append(printFatCat).append(", ").append(newline).append(" show3d=").append(show3d).append(", ")
				.append(newline).append(" autoFetch=").append(autoFetch).append(", ").append(newline)
				.append(" printCE=").append(printCE).append(", ").append(newline).append(" showMenu=").append(showMenu)
				.append(", ").append(newline).append(" printPDB=").append(printPDB).append(", ").append(newline)
				.append(" isDomainSplit=").append(isDomainSplit).append(", ").append(newline).append(" alignPairs=")
				.append(alignPairs).append(", ").append(newline).append(" searchFile=").append(searchFile).append(", ")
				.append(newline).append(" saveOutputDir=").append(saveOutputDir).append(", ").append(newline)
				.append(" nrCPU=").append(nrCPU).append("]").toString();
	}
