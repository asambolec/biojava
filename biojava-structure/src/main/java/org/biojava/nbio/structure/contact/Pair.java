...
/**
 * A Pair of objects. Implements an equals and hashCode so that it can be used
 * as key in hashes. Based on the JUNG graph library implementation.
 *
 * @author duarte_j
 *
 * @param <T>
...
public final class Pair<T> implements Serializable {
	...
	public String toString() {
		return new StringBuilder().append("<").append(first.toString()).append(", ").append(second.toString())
				.append(">").toString();
	}
}
