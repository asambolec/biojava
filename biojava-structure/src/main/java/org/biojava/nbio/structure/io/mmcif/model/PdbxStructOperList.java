...
public class PdbxStructOperList implements Serializable {
	...
	private String symmetryOperation;
	...
	public String toString() {
		return new StringBuilder().append("PdbxStructOperList [id=").append(id).append(", type=").append(type)
				.append("]").toString();
	}
	...
	public void setSymmetry_operation(String symmetry_operation) {
		this.symmetryOperation = symmetry_operation;
	}
