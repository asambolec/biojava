 ...
 * multiple alignment. It is described by a collection of {@link Block}s and a
 * transformation matrix for every structure.
 * <p>
 ...
 * description of alignments with several flexible parts. Every BlockSet object
 * is part of a {@link MultipleAlignment} instance, its parent.
 *
 * @author Aleix Lafita
...
public interface BlockSet extends ScoresCache {
	...
	/**
	 * Creates and returns an identical copy of this blockset, including a deep copy
	 * of all constituent {@link Block}s.
	 *
	...
	/**
	 * Returns the parent MultipleAlignment of the BlockSet. Returns null if there
	 * is no referenced object.
	 *
	 * @return MultipleAlignment the parent MultipleAlignment of the BlockSet, or
	 *         null.
	 ...
	 * <p>
	 * Neither removes this BlockSet from its previous alignment, if any, nor adds
	...
	/**
	 * Returns the List of alignment Blocks of the BlockSet. It initializes a new
	 * List of Blocks if it is null.
	 * 
	...
	/**
	 * Returns a transformation matrix for each structure giving the 3D
	 * superimposition information of the multiple structure alignment.
	 *
	...
	/**
	 * Set a new superposition for the structures. This may trigger other properties
	 * to update which depend on the superposition.
	 *
	 * @param matrices
	 */
	...
	/**
	 * Returns the total number of aligned residues (columns) in the alignment: the
	 ...
	 * alignment Block Set. The values can be used to compute the coverages.
	 * 
