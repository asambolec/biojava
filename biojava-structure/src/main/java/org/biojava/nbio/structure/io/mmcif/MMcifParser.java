...
public interface MMcifParser {
	...
	/**
	 * Add a MMcifConsumer that listens to even being triggered by the parser and
	 * processes the data into a backend provided by the Consumer.
	 *
	...
	/**
	 * Start the actual parsing. The parser will trigger events that are defined by
	 * the MMcifConsumer class.
	 *
