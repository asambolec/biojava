...
public class MmtfSummaryDataBean {
	...
	/**
	 * @return the map of chain ids (strings asymId) to the index of that chain in
	 *         the allChains list. This only applies for the first model in the
	 *         structure.
	 */
	...
	/**
	 * @param chainIdToIndexMap the map of chain ids (strings asymId) to the index
	 *                          of that chain in the allChains list. This only
	 *                          applies for the first model in the structure.
	 */
