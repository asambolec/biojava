...
public final class StandardAminoAcid {
	 ...
	 *
	 * <p>
	 * This parses the resource <code>{@value #STANDARD_AMINOS_FILE}</code> and
	 * builds a basic set of amino acids.
	 * </p>
	 * 
	 * @author Tamas Horvath provided the standard amino acids
	 */
	static {
		...
		if (fileStream == null) {
			throw new RuntimeException(new StringBuilder().append("Could not find resource ")
					.append(STANDARD_AMINOS_FILE)
