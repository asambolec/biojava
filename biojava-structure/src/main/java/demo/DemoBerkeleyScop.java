...
/**
 * A demo for how to use the Berkeley version of SCOP instead of the default
 * UK-SCOP
 *
 * @author andreas
 * @since 3.0.4
...
public class DemoBerkeleyScop {
	...
	public static void main(String[] args) {
		...
		logger.info(cache.getPath());
		logger.info(cache.getCachePath());
		// ... and do something with it

		// eg. you can run all the demos that work for the UK - SCOP (currently at
		// version 1.75)
