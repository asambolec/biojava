...
/**
 * This class contains the processed data of embl file that contains the
 * referenceNumber, referenceComment, referencePosition referenceCrossReference,
 * referenceGroup, referenceAuthor referenceTitle, referenceLocation
 *
...
public class EmblReference {
	 ...
	 * Citation within an entry. This number is used to designate the reference in
	 * comments and in the feature table.
	 *
	 ...
	 * appears if one or more contiguous base spans of the presented sequence can be
	 * attributed to the reference in question.
	 *
	 * @return String
	 */
	...
	/**
	 * The RA (Reference Author) lines list the authors of the paper (or other work)
	 * cited. All of the authors are included, and are listed in the order given in
	 * the paper.
	 *
	 * @return String
	 */
