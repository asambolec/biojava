...
public class EmblRecord {
	...
	/**
	 * The ID (IDentification) line The tokens represent: 1. Primary accession
	 * number 2. Sequence version number 3. Topology: 'circular' or 'linear' 4.
	 * Molecule type 5. Data class 6. Taxonomic division 7. Sequence length
	 *
	 * @return EmblId
	 */
	...
	/**
	 * The Reference (RN, RC, RP, RX, RG, RA, RT, RL) Lines These lines comprise the
	 * literature citations within the database. The citations provide access to the
	 * papers from which the data has been abstracted.
	 *
	 ...
	 * entry when it is printed or displayed on a terminal screen.
	 *
	 * @return String
	 */
	...
	/**
	 * The OS (Organism Species) line specifies the preferred scientific name of the
	 * organism which was the source of the stored sequence. In most cases this is
	 * done by giving the Latin genus and species designations, followed (in
	 * parentheses) by the preferred common name in English where known.
	 *
	 * @return String
	 */
	...
	/**
	 * The AH (Assembly Header) line provides column headings for the assembly
	 * information.
	 *
	 * @return String
	 */
	 ...
	 * chromosomes, genomes and other long sequences constructed from segment
	 * entries.
	 *
	 * @return String
	 */
