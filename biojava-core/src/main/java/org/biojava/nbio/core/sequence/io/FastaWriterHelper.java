...
/**
 * The class that should be used to write out fasta file of a sequence
 * collection
 * 
...
public class FastaWriterHelper {
	...
	public static void writeProteinSequence(OutputStream outputStream, Collection<ProteinSequence> proteinSequences)
		...
		FastaWriter<ProteinSequence, AminoAcidCompound> fastaWriter = new FastaWriter<>(outputStream, proteinSequences,
	...
	/**
	 * Write a collection of GeneSequences to a file where if the gene is negative
	 * strand it will flip and complement the sequence
	 * 
	 * @param file
	 * @param geneSequences
	 * @throws Exception
	...
	public static void writeGeneSequence(File file, Collection<GeneSequence> geneSequences, boolean showExonUppercase)
			throws Exception {
		FileOutputStream outputStream = new FileOutputStream(file);
		BufferedOutputStream bo = new BufferedOutputStream(outputStream);
	...
	public static void writeGeneSequence(OutputStream outputStream, Collection<GeneSequence> geneSequences,
			boolean showExonUppercase) throws Exception {
		FastaGeneWriter fastaWriter = new FastaGeneWriter(outputStream, geneSequences,
	...
	public static void writeNucleotideSequence(OutputStream outputStream, Collection<DNASequence> dnaSequences)
			throws Exception {
		FastaWriter<DNASequence, NucleotideCompound> fastaWriter = new FastaWriter<>(outputStream, dnaSequences,
	...
	public static void writeSequences(OutputStream outputStream, Collection<Sequence<?>> sequences) throws Exception {
		...
		FastaHeaderFormatInterface<Sequence<?>, Compound> fhfi = (Sequence<?> sequence) -> sequence.getAccession()
				.toString();

		FastaWriter<Sequence<?>, Compound> fastaWriter = new FastaWriter<>(outputStream, sequences, fhfi);
