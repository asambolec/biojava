...
/**
 * Ambiguity set for hybrid DNA/RNA sequences. Needed for some instances of
 * synthetic nucleotide sequences present in protein structures from the PDB.
 *
 * @author Jose Duarte
 *
 */
public class AmbiguityDNARNAHybridCompoundSet extends DNACompoundSet {
	...
	public AmbiguityDNARNAHybridCompoundSet() {
		// this is the only one needed to make it a hybrid DNA/RNA. The rest are the
		// usual DNA/RNA ambiguity letters
