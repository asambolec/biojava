 ...
 * {@link List} returned is unmodifiable unless the class implements the
 * subinterface {@link MutableProfile}.
 *
 * @author Mark Chapman
 * @author Paolo Pavan
...
public interface Profile<S extends Sequence<C>, C extends Compound> extends Iterable<AlignedSequence<S, C>> {
	...
	/**
	 * Searches for the given {@link Sequence} within this alignment profile.
	 * Returns the corresponding {@link AlignedSequence}.
	 *
	...
	/**
	 * Returns a {@link List} containing the individual {@link AlignedSequence}s of
	 * this alignment.
	 *
	...
	/**
	 * Returns a {@link List} containing some of the individual
	 * {@link AlignedSequence}s of this alignment.
	 *
	...
	/**
	 * Returns the {@link Compound} at row of given sequence and column of alignment
	 * index. If the given sequence has overlap, this will return the
	 * {@link Compound} from the top row of the sequence.
	 *
	 * @param listIndex      index of sequence in profile
	 * @param alignmentIndex column index within an alignment
	 * @return the sequence element
	 * @throws IndexOutOfBoundsException if listIndex < 1, listIndex > number of
	 *                                   sequences, alignmentIndex < 1, or
	 ...
	 * {@link Compound} from the top row of the sequence.
	 *
	 * @param sequence       either an {@link AlignedSequence} or an original
	 *                       {@link Sequence}
	 * @param alignmentIndex column index within an alignment
	 * @return the sequence element
	...
	/**
	 * Returns the number of each {@link Compound} in the given column for all
	 * compounds in {@link CompoundSet}.
	 *
	 * @param alignmentIndex column index within an alignment
	...
	/**
	 * Returns the number of each {@link Compound} in the given column only for
	 * compounds in the given list.
	 *
	 * @param alignmentIndex column index within an alignment
	...
	/**
	 * Returns the fraction of each {@link Compound} in the given column for all
	 * compounds in {@link CompoundSet}.
	 *
	 * @param alignmentIndex column index within an alignment
	...
	/**
	 * Returns the fraction of each {@link Compound} in the given column only for
	 * compounds in the given list.
	 *
	 * @param alignmentIndex column index within an alignment
	 * @param compounds      list of compounds to count
	...
	/**
	 * Returns the indices in the original {@link Sequence}s corresponding to the
	 * given column. All indices are 1-indexed and inclusive.
	 *
	 * @param alignmentIndex column index within an alignment
	...
	/**
	 * Searches for the given {@link Compound} within this alignment profile.
	 * Returns column index nearest to the start of the alignment profile, or -1 if
	 * not found.
	 *
	 * @param compound search element
	 * @return index of column containing search element nearest to the start of the
	 *         alignment profile
	 */
	...
	/**
	 * Searches for the given {@link Compound} within this alignment profile.
	 * Returns column index nearest to the end of the alignment profile, or -1 if
	 * not found.
	 *
	 * @param compound search element
	 * @return index of column containing search element nearest to the end of the
	 *         alignment profile
	 */
	...
	/**
	 * Returns a {@link List} containing the original {@link Sequence}s used for
	 * alignment.
	 *
	...
	/**
	 * Returns the number of rows in this profile. If any {@link AlignedSequence}s
	 * are circular and overlap within the alignment, the returned size will be
	 * greater than the number of sequences, otherwise the numbers will be equal.
	 *
	...
	/**
	 * Returns a {@link ProfileView} windowed to contain only the given
	 * {@link Location}. This only includes the {@link AlignedSequence}s which
	 * overlap the location.
	 *
	...
	/**
	 * Returns true if any {@link AlignedSequence} is circular. If so, sequences may
	 * simply wrap around from the end to the start of the alignment or they may
	 * contribute multiple overlapping lines to the profile.
	 *
	 ...
	 * end indices of the profile and each sequence for each group of lines of the
	 * given width. Each line may also be labeled.
	 *
