...
/**
 * This class contains the processed data of embl file Primary accession number
 * Sequence version number Topology: 'circular' or 'linear' Molecule type Data
 * class Taxonomic division Sequence length
 *
...
public class EmblId {
	...
	public EmblId(String primaryAccession, String sequenceVersion, String topology, String moleculeType,
			String dataClass, String taxonomicDivision, String sequenceLength) {
	 ...
	 * (the total number of bases in the sequence). This number includes base
	 * positions reported as present but undetermined (coded as "N").
	 *
	 * @return String
	 */
