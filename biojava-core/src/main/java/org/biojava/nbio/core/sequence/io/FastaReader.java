...
public class FastaReader<S extends Sequence<?>, C extends Compound> {
	...
	public static void main(String[] args) {
		try {
			...
			if (is == null) {
				logger.error("Could not get input file " + inputFile);
			}
			...
			FastaReader<ProteinSequence, AminoAcidCompound> fastaProxyReader = new FastaReader<>(file,
					new GenericFastaHeaderParser<ProteinSequence, AminoAcidCompound>(),
			...
			proteinProxySequences.keySet().forEach(key -> {
