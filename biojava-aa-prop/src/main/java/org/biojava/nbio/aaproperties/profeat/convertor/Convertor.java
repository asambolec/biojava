...
public abstract class Convertor {
	 ...
	 * An abstract class to convert a protein sequence into representation of
	 * different attribute with each attribute having 3 groups.<br/>
	...
	/**
	 * Returns the grouping of the amino acid character. The aminoAcid argument is
	 * preferably of non-ambiguous characters. Standard amino acids will be
	 * converted to '1', '2' or '3' depending on its grouping Non-standard amino
	 * acids are simply converted to '0'.
	 *
	 * @param aminoAcid an amino acid character preferably of non-ambiguous
	 *                  characters
	 * @return its grouping
	 */
	...
	/**
	 * Returns the converted sequence. The sequence argument must be a protein
	 * sequence consisting of preferably non-ambiguous characters only. Standard
	 * amino acids will be converted to '1', '2' or '3' depending on its grouping
	 * Non-standard amino acids are simply converted to '0'.
	 *
	 * @param sequence a protein sequence consisting of preferably non-ambiguous
	 *                 characters only
