...
public class DemoShowBiolAssembly {
	...
	private static final Logger logger = LoggerFactory.getLogger(DemoShowBiolAssembly.class);
	...
	public static void main(String[] args) {
		...
		try {
			...
			jmolPanel.evalString(
					"select * ; color structure ; spacefill off; wireframe off; backbone off; cartoon on; select ligands ; spacefill 0.4; color cpk; model 0;");
