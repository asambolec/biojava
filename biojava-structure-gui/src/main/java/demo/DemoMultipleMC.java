...
/**
 * Demo for running the CEMC Algorithm on a protein family and visualizing the
 * results. Choose the family by commenting out the protein family names.
 *
 * @author Aleix Lafita
 *
 */
public class DemoMultipleMC {
	...
	public static void main(String[] args)
		...
		// List<String> names = Arrays.asList("d1hm9a1", "d1kk6a_", "d1krra_",
		// "d1lxaa_", "d1ocxa_", "d1qrea_", "d1xata_", "d3tdta_");
		...
		// List<String> names = Arrays.asList("2pel.A", "2eig.A", "1uzy.A", "1lec.A",
		// "3cna.A", "4i30.A", "4z8b.A", "2d3p.A");
		...
		// List<String> names =
		// Arrays.asList("2dyr.A","2gsm.A","1fft.A","1xme.A","3o0r.B","3ayf.A");
