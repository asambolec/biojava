...
public class WebStartClientDemo {
	...
	public static void main(String[] args) {
		...
		// client.main(new String[]{"fatcat", "3BMV.A","2GUY.A",
		// "http://pdb114.rcsb.org:8080/jfatcatserver/align/"});
		// client.main(new String[]{"fatcat", "2GUY.A","3BMV.A"});

		// client.main( new String[]{"fatcat",
		// "1EXQ.A","1EX4.B","http://pdb114.rcsb.org:8080/jfatcatserver/align/"} );
