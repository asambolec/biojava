...
public class SequenceScalePanel extends JPanel {
	...
	// LoggerFactory.getLogger(SequenceScalePanel.class);
	...
	protected int drawScale(Graphics2D g2D, int y) {
		...
		// System.out.println("SeqScalePanel drawing scale s:" + startpos + " e: " +
		// endpos +
		// " ps: " + drawStart + " pe:" + drawEnd + " draw.x " + drawHere.x + " draw.w "
		// + drawHere.width +
		// " scale " + scale);
