...
public abstract class JmolSymmetryScriptGenerator {
	...
	/**
	 * Returns an instance of a JmolSymmetryScriptGenerator, based on the symmetry
	 * of a structure (factory method)
	 * 
	 * @param axisAligner
	 * @param rotationGroup
	...
	/**
	 * Returns the Jmol zoom to fit polyhedron and symmetry axes. This zoom level
	 * should be used so that the polyhedron and symmetry axes are not cutoff.
	 * 
	 * @return
	 */
	...
	/**
	 * Sets a default Jmol script used for coloring. This method is used in local
	 * symmetry cases to color those subunits that are not related by symmetry.
	 * 
	 * @param colorScript
	 */
	...
	/**
	 * Sets the type of bioassembly to be colored. If set to true, it will generate
	 * a Jmol script for a bioassembly generated by Jmol on the fly. If set to
	 * false, it will generate Jmol script for a bioassembly file read by Jmol.
	 */
	...
	protected static String getJmolColor(Color4f color) {
		...
		return new StringBuilder().append(" [x").append(hex).append("]").toString();
	}
