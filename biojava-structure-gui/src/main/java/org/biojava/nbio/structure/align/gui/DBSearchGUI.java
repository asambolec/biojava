...
public class DBSearchGUI extends JPanel {
	...
	private JPanel createListPane() {
		...
		chB.addActionListener((ActionEvent e) -> {
	...
	private Box createDomainSelectPane() {
		...
		domainList.setToolTipText(
				"Either align whole chains or SCOP domains and domains assigned with PDP, where no SCOP available.");
		domainList.addActionListener((ActionEvent arg0) -> {
