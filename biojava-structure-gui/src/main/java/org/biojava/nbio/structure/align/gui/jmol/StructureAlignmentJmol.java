...
public class StructureAlignmentJmol extends AbstractAlignmentJmol implements ChangeListener {
	...
	public StructureAlignmentJmol(AFPChain afpChain, Atom[] ca1, Atom[] ca2) {
		...
		labelTable.put(Integer.valueOf(300), new JLabel("300%"));
		labelTable.put(Integer.valueOf(400), new JLabel("400%"));
		labelTable.put(Integer.valueOf(500), new JLabel("500%"));
		...
		toggleSpin.addItemListener((ItemEvent e) -> {
	...
	private static void printJmolScript4Block(Atom[] ca1, Atom[] ca2, int blockNum, int[] optLen, int[][][] optAln,
		...
		buf.append(new StringBuilder().append("; backbone 0.6 ; color [").append(c1.getRed()).append(",")
				.append(c1.getGreen()).append(",").append(c1.getBlue()).append("]; select ").toString());
		...
		buf.append(new StringBuilder().append("; backbone 0.6 ; color [").append(c2.getRed()).append(",")
				.append(c2.getGreen()).append(",").append(c2.getBlue()).append("];").toString());
