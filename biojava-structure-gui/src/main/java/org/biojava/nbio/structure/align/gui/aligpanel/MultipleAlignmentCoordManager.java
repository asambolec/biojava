...
public class MultipleAlignmentCoordManager {
	...
	public int getPreferredWidth() {
		return alignmentSize * DEFAULT_X_SPACE + DEFAULT_LINE_LENGTH * DEFAULT_CHAR_SIZE + DEFAULT_LEGEND_SIZE
	...
	public int getPreferredHeight() {
		return alignmentSize * DEFAULT_Y_SPACE + (alignmentLength / DEFAULT_LINE_LENGTH) * DEFAULT_Y_STEP
				+ DEFAULT_LINE_SEPARATION;
	}

	/**
	 * Convert from an X position in the JPanel to the position in the sequence
	 * alignment.
	 *
	...
	/**
	 * Returns the index of the structure, for a given point in the Panel. Returns
	 * -1 if not over a position in the sequence alignment.
	 * 
	...
	/**
	 * Provide the coordinates for where to draw the legend for line X given the
	 * structure index.
	 *
