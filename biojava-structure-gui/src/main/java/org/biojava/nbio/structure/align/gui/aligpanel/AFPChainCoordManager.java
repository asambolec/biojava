...
public class AFPChainCoordManager {
	...
	public int getPreferredWidth() {
		return 2 * DEFAULT_X_SPACE + DEFAULT_LINE_LENGTH * DEFAULT_CHAR_SIZE + DEFAULT_LEGEND_SIZE
	...
	public int getPreferredHeight() {
		return 2 * DEFAULT_Y_SPACE + (afpChain.getAlnLength() / DEFAULT_LINE_LENGTH) * DEFAULT_Y_STEP
	...
	public int getAligSeq(Point point) {
		...
		// System.out.println(" i1: " + i1 +" t1 : " + Math.abs(t1.x - point.x) + " " +
		// Math.abs(t1.y-point.y));
	...
	/**
	 * provide the coordinates for where to draw the legend for line X and if it is
	 * chain 1 or 2
	 *
