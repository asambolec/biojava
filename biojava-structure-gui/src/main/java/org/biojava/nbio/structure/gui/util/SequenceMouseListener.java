...
/**
 * a mouse listener for the AbstractChainRenderer class it listens to all mouse
 * events and triggeres appropriate SequenceListener and FeatureListener events
 *
...
public class SequenceMouseListener implements MouseListener, MouseMotionListener {
	...
	// LoggerFactory.getLogger(SequenceMouseListener.class);
	...
	protected void triggerMouseOverPosition(int pos, int mouseY) {
		...
		alignmentPositionListeners.forEach(li -> li.mouseOverPosition(apos.get(pos)));
